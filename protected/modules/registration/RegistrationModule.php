...
class RegistrationModule extends CWebModule {
	...
	public $recoveryUrl = array('//registration/registration/recovery');
        ...
        //Whether to activate Account Approval from site owner/staff.
        //If true user account will activate on site owner's/staff's approval.
        public $enableApprovalRequired = true;
        
        //Whether the user has to choose an account type before registration or not.
        public $enableChooseAccountType = true;
