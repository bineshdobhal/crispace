...
public function getRoles() {
	...
	public function isAdmin() {
        ...
        /**
         * Check if the loged in user is a staf member or not
         * 
         * @return BOOLEAN TRUE if the user is a staff member(user_type = staff member), false otherwise.
         */
        public function isStaff(){
            $return = false;
            if(!$this->isGuest){
                if(Yii::app()->user->data()->user_type == YumUser::USERTYPE_STAFF)
                    $return = true;
            }
        ...
        public function getUserType(){
            if($this->isGuest)
                ...
                return Yii::app()->user->data()->user_type;
        }
}
?>
