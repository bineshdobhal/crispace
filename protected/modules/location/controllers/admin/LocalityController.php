...
class LocalityController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Locality']))
		{
			...
			if($model->save())
				$this->redirect(array('view','id'=>$model->LOCAL_ID));
		}
	...
	{
		$dataProvider=new CActiveDataProvider('Locality');
	...
	{		
	    ...
	    if($request!=''){
	        $model=City::model()->findAll(array("condition"=>"city_name like '$request%'"));
	        $data=array();
